...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2014 a las 03:35:35
...
(1, 'categoria a', 'descripcion de la categoria a'),
...
(123968574, 'fabio', 'arbelaez', 'carrera', 2147483647, 'fabio@hotmail.com'),
(789456123, 'Juan', 'Paredes', 'carreta 9', 321456789, 'Juan@hotmail.com'),
...
(1, '2014-11-29', 1111111113, 2147483647, 99440, 523560, 623000, 'Registrada'),
(2, '2014-11-29', 1111111113, 2147483647, 16000, 84003, 100003, 'Sin registra'),
(3, '2014-11-29', 1111111113, 123968574, 4800, 37200, 42000, 'Sin registra'),
(4, '2014-11-29', 1111111113, 2147483647, 32800, 187200, 220000, 'Sin registra'),
(5, '2014-11-29', 1111111113, 2147483647, 1920, 22080, 24000, 'Registrada');
...
('00001', 'producto a', 'descripcion del producto a', 10000, 'SI', '16', '12', '123', 50, 'Disponible'),
...
('100094', 'caneca Aguardiente Blanco sin ', 'Producto  etilico en presentación de 375cc', 10000, 'SI', '16', '9000', '15000', 396, 'Disponible'),
('100095', 'botella Aguardiente Blanco sin', 'Producto  etilico en presentación de 750cc', 10000, 'SI', '16', '20000', '25000', 388, 'Disponible'),
('100099', 'Cuaderno argollado cuadriculad', 'Producto  esencial para estudiantes', 10000, 'SI', '10', '800', '1400', 400, 'Disponible'),
('101010E', 'acetaminofen', 'semillas del ermitaño en presentación de 30 unidades por caja ', 10002, 'SI', '8', '2500', '3000', 891, 'Disponible'),
('101010J', 'elmo cosquillas', 'peluche de la clasica serie "plaza sesamo"', 10004, 'SI', '16', '150000', '190000', 17, 'Disponible'),
('7894', 'jabon', 'hace espuma y limpia Bien', 10000, 'SI', '17', '1200', '2000', 192, 'Disponible');
...
(66725237, 'Beatriz Eliana', 'Rincon', 'beatriz', '12345', 'Lugar de nacimiento?', 'belen', 'CC', 'Tulua', 'Calle 33 #22-0 - Barrio', 35, 'https://fbcdn-sphotos-a-a.akamaihd.net/hphotos-ak-xaf1/v/t1.0-9/484581_116115091853200_1230645316_n.jpg?oh=9bd01ed488658003224494ae6f39f777&oe=54CF8688&__gda__=1418923097_61697874751c8628ccb14f80d1c53', 3173895745, 'beatrizeliana11@gmail.com', 'F', 7),
(986357421, 'fabian', 'cordoba', 'fabia', '123456', 'pregunta pregunta', 'respuesta', 'CC', 'tulua', 'carrera 8', 23, 'http://aaa.com', 3153246987, 'fabian@hotmail.com', 'M', 7),
...
(1116266234, 'Jhonier', 'asdasdasdasdasdasdasdasd', 'jhonier', '123456', 'Segundo nombre?', 'edinson', 'CC', 'Tulua', 'Calle 33 #333-33 - Barrio', 20, 'sdfgsdgfdgsasdasdasdasd', 2147483647, 'jevalenciac@gmail.com', 'M', 1),
...
(7894562789, 'cristhian', 'alvarez', 'cristian', '12345678', 'nombre de la primera persona que vi ', 'no se', 'CC', 'tulau', 'carrera 8', 15, 'http://aaa.com', 3164962117, 'cristhian@hotmail.com', 'M', 3);
...
--
ALTER TABLE `listaproductos`
MODIFY `id_principal` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=183;
--
